              ...
              children: [
                ...
                Card(
                  ...
                  shape: RoundedRectangleBorder(
                      ...
                      side: const BorderSide(width: 1, color: Colors.grey)),
                  child: Container(
                    child: context.watch<LocationProvider>().listProvince != null
                        ? DropdownButtonFormField<String>(
                            decoration: const InputDecoration(
                              focusedBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: Colors.transparent),
                ...
                Card(
                  ...
                  shape: RoundedRectangleBorder(
                      ...
                      side: const BorderSide(width: 1, color: Colors.grey)),
                  child: Container(
                    child: context.watch<LocationProvider>().listDistrict != null
                        ? DropdownButtonFormField<String>(
                            decoration: const InputDecoration(
                              focusedBorder: UnderlineInputBorder(
                                borderSide: BorderSide(color: Colors.transparent),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        context.go('/home');
                        String address2 =
                            '${textController.text ?? ''}, ${ward ?? ''}, ${district ?? ''}, ${province ?? ''}, ${country ?? ''}';
                        context
                            .read<LocationProvider>()
                            .updateAddressUser(address2);
                      },
                      child: const Text(
                        'Confirm',
