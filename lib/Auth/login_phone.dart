...
import '../config/helpers/helpers_validators.dart';
...
class LoginWithPhoneNumber extends StatelessWidget {
  ...
  //       phoneNumber: '$selectedCountry ${_textEditingController.text}' ,
  ...
  //         context.goNamed('verify_otp', queryParameters: {'phoneNumber':'$selectedCountry${_textEditingController.text}'});
  //       },
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ElevatedButton(
                            onPressed: () async {
                              await myProvider.onSubmitPhone(context);
                            },
