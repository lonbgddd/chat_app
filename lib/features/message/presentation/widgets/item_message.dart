...
class MyItemMessage extends StatefulWidget  {
  final String? uid;
  ...
  @override
  State<MyItemMessage> createState() => _MyItemMessageState();
}

class _MyItemMessageState extends State<MyItemMessage>  with AutomaticKeepAliveClientMixin{
  @override
