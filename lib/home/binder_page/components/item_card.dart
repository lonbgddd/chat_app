...
import 'package:chat_app/home/binder_page/components/photo_item_card.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack( children: [
        SizedBox.expand(
            child: isFront! ? buildCard(context) : cardProfile(context)),
                ...
                buildFloatingButton(
                    ...
                    colorBorder:
                        Provider.of<BinderWatch>(context).getStatus() ==
                            ...
                            ? Colors.white
                            : const Color.fromRGBO(109, 229, 181, 1),
                    onTap: () => Provider.of<BinderWatch>(context,listen: false).like(context)),
                buildFloatingButton(
                  width: 40,
                  height: 40,
                  padding: 10,
