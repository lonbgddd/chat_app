        ...
        PageView.builder(
          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              ...
              child: (widget.photoList.length != 0) ? Container(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Column(
                            children: [
                              (currentAddress.isNotEmpty && currentIndex == 0)
                                ? buildInfo(icon: Icons.home_outlined,content: AppLocalizations.of(context).livingIn + HelpersUserAndValidators.extractCity(widget.targetUser!.currentAddress.toString(),',',2))
                                : SizedBox.shrink(),
                      ...
                      (widget.targetUser.interestsList.length > 0 && currentIndex == 2)
                          ? generateInterestsList (HelpersUserAndValidators.getItemFromListIndex(context, HelpersUserAndValidators.interestsList(context),  widget.targetUser.interestsList)) : SizedBox.shrink(),

                      (HelpersUserAndValidators.isListNotEmpty(HelpersUserAndValidators.styleOfLifeUserList(context,widget.targetUser)) && currentIndex == 3)
                          ? generateInterestsList (HelpersUserAndValidators.styleOfLifeUserList(context,widget.targetUser)) : SizedBox.shrink(),
                    ],
                  ),
                ),
                InkWell(
                ...
                if (index < defaultItemIndex && list[index].isNotEmpty ) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child:
                      Text(AppLocalizations.of(context).textShowMore, style: TextStyle(color: Colors.white,fontSize: 13, fontWeight: FontWeight.w700),textAlign: TextAlign.start,),
                    ),
                  );
                }else {
                  return SizedBox();
